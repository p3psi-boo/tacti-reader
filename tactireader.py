...
from PyQt5.QtCore import Qt, QMimeData, QPointF,QEvent, QPoint, QRect, QRectF, pyqtSignal, pyqtSlot,QUrl,QTimer
...
class TactiReader(QMainWindow):
    ...
    def _fill_toc_tree(self):
        ...
        for entry in self.pdf_toc:
            ...
            # 设置固定宽度并留出充足边距
            label.setFixedWidth(available_width - 30)  # 额外减去30px防止裁剪
            label.adjustSize()
            # ===================================
